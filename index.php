...
$error_text     = ' Request_error: ' . json_encode($message_t);
...
if(!empty(file_get_contents($file_chat))) {
    /******************************************************************************/
    ...
    /******************************************************************************/
    elseif(!empty(file_get_contents($file_request))) {
        $type = file_get_contents($file_request);
    ...
    elseif(strlen($number) == 4) {
        $code = file_get_contents($file_sms);
